...
//Java program to calculate fraction and round up the value
//of two numbers
import java.util.*;
...
class GFG {
	...
	public static String calculateFraction(int num, int den) {
		...
		result.append(".");
		Map<Long, Integer> m = new HashMap<Long, Integer>(); // map for storing remainder
		...
		while (rem != 0) {
			...
			//System.out.println(rem + " kiri "+ den+ "  "+result.length());
			quo = rem / den;
